# Contributing to Eugene Plexus `data`

Thanks for your interest. This service implements the `data` OpenAPI contract from [`eugene-plexus/specs`](https://github.com/eugene-plexus/specs) — please read this before opening a PR.
...
- **Engine work** — the data-preparation engine: import, cleaning, splitting, tokenizer training, pretokenization.
...
```bash
git clone https://github.com/eugene-plexus/data
cd data
python -m venv .venv
...
File issues at <https://github.com/eugene-plexus/data/issues>. Useful issues include:

- Concrete import / pretokenization failures with reproduction steps.
- Spec-vs-impl divergence (the impl drifted from `data.yaml`).
